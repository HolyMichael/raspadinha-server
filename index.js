						...
						crypto.subtle.importKey("jwk", //can be "jwk" or "raw"
							...
							mongo.connect(url, { useNewUrlParser: true }, (err, client) => {
								...
								var myobj = {
									...
									aes_server_client: aes_server_client, aes_client_server: aes_client_server, balanco: 0
								};
			...
			socket.on("reply_to_challenge", (signature) => {
				...
				mongo.connect(url, { useNewUrlParser: true }, (err, client) => {
					...
					collection.find({ name: username }).toArray(function (err, result) {
						...
						client_server_aes = result[0].aes_client_server.data

						let json_key = {
							alg: "A256CTR",
							ext: true,
							k: client_server_aes.toString("base64"),
							key_ops: ["encrypt", "decrypt"],
							kty: "oct"
						}
						...
						crypto.subtle.importKey(
							...
							.then(function (key) {
								crypto.subtle.decrypt(
									...
									signature //ArrayBuffer of the data
									...
									crypto.subtle.importKey(
										...
										crypto.subtle.verify(
											...
											//validacao ca nonce, se result == true authenticate, else authentication failed
